...
namespace DVLD_BussinessLayer
{
    public class clsLicenseInfo
    {
        ...
        static public clsLicenseInfoDTO GetLicenseDriverDataUsingLicenseID(int LicenseID)
        {
            clsLicenseInfoDTO licenseInfoDTO = new clsLicenseInfoDTO();

            DataTable dataTable = new DataTable();
            dataTable = clsLicenseInfoData.GetLicenseDriverDataUsingLicenseID(LicenseID);
        ...
        static public bool CheckIfLocalLicenseExist(int LicenseID)
        {
            return clsLicenseInfoData.CheckIfLicenseExist(LicenseID);
        }
